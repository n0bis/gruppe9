 ...
 * @author morte
 */
public class TowardsMainhall2Controller extends MenuControllerInjection implements Initializable, IPlaySound, INavigate {
    ...
    public SoundMapper mapSound() {
        return new SoundMapper(0.8, "/sounds/spooky.mp3");
    }
